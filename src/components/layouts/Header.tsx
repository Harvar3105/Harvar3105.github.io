...
export default function Header() {
  const navButtonsStyle =
    "inline-flex items-center justify-center text-sm font-medium hover:text-[var(--hover-text)] hover:bg-[var(--hover-background)] py-3 px-5 border-b-2 hover:border-b-[var(--accent-color)] border-transparent";
  ...
  return (
    ...
    >
      <div className="relative w-full h-full">
        <nav
          className={`absolute inset-0 flex items-center justify-between transition-opacity duration-[750ms] ${
